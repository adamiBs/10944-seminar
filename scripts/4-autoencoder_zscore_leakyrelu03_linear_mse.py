...
metrics_path = '/workspaces/10944-seminar/images/4-autoencoder_zscore_leakyrelu03_linear_mse_metrics.txt'
...
plt.tight_layout()
plt.savefig('/workspaces/10944-seminar/images/4-autoencoder_zscore_leakyrelu03_linear_mse_metrics.png', dpi=300)
plt.close()
