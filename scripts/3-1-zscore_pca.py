...
plt.title('Z-score Normalized PCA - Iris Dataset (2D Visualization)')
plt.legend(loc='best')
plt.grid(True)

# Save the 2D visualization
output_path_2d = "/workspaces/10944-seminar/images/3-1-zscore_pca_2d.png"
...
visualize_3d_scatter(
    data=data_pca_3d, 
    target=target,
    title="Z-score Normalized + PCA - Iris Dataset (2D → 3D Visualization)",
