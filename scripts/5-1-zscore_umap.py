...
plt.title('Z-score Normalized UMAP - Iris Dataset (2D Visualization)')
plt.legend(loc='best')
plt.grid(True)

# Save the 2D visualization
output_path_2d = "/workspaces/10944-seminar/images/5-1-zscore_umap_2d.png"
...
output_path = "/workspaces/10944-seminar/images/5-1-zscore_umap_3d.png"
visualize_3d_scatter(
    data=data_umap_3d, 
    target=target,
    title="Z-score Normalized + UMAP - Iris Dataset (2D → 3D Visualization)",
