...
encoded_normalized = encoder.predict(X_test_normalized)  # MinMax normalized test data
...
plt.tight_layout()
plt.savefig('/workspaces/10944-seminar/images/8-4-autoencoder_minmax.png', dpi=300)
plt.close()
