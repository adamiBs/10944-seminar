...
plt.title('Parametric t-SNE Training Loss (MinMax)')
plt.xlabel('Epochs')
plt.ylabel('Loss (MSE)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('/workspaces/10944-seminar/images/8-6-parametric_tsne_loss.png', dpi=300)
plt.close()
...
plt.title('Parametric t-SNE (MinMax Normalized Input)', fontsize=14)
plt.xlabel('Dimension 1', fontsize=12)
plt.ylabel('Dimension 2', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig('/workspaces/10944-seminar/images/8-6-parametric_tsne_minmax.png', dpi=300)
plt.close()
